...
traj <- toy_tasks %>% filter(id == "toy/bifurcating_1") %>% extract_row_to_list(1)
traj <- traj %>% add_root()
...
```{r features, echo=FALSE, fig.width=10, fig.height=6, include=FALSE}
plot_features(traj, features_oi = 5)
```

check_or_perform_dimred <- function(object, insert_phantom_edges, color_by=c("Set3", "rainbow")) {
  if (is_data_wrapper(object) && is_wrapper_with_trajectory(object)) {
    ...
    stop(sQuote("object"), " is not an object as generated by dimred_trajectory or wrap_data")
  }
  dimred_object
}
...
#'  \code{\link[dynwrap]{wrap_data}}
#' @param insert_phantom_edges attempt to plot bifurcating edges correctly automatically
#' @param color_by How to color the edges, either using Set3 or using rainbow
#'

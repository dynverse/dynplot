...
#'
#' @param object output as generated by \code{\link{dimred_trajectory}} or \code{\link[dynutils]{wrap_data}}
...
#' Plot a dimensionality reduced trajectory
#'
#' @param original_object output as generated by \code{\link{dimred_trajectory}} or \code{\link[dynutils]{wrap_data}}
#' @param new_object output as generated by \code{\link{dimred_trajectory}} or \code{\link[dynutils]{wrap_data}}
#' @param insert_phantom_edges attempt to plot bifurcating edges correctly automatically
#'
#' @importFrom grid arrow
#' @importFrom cowplot theme_cowplot

...
#'
#' @param object output as generated by \code{\link{dimred_trajectory}}, \code{\link{wrap_ti_task_data}} or \code{\link[dynmethods]{wrap_prediction_model}}
...
#' Plot a dimensionality reduced trajectory
#'
#' @param original_object output as generated by \code{\link{dimred_trajectory}}, \code{\link{wrap_ti_task_data}} or \code{\link[dynmethods]{wrap_prediction_model}}
#' @param new_object output as generated by \code{\link{dimred_trajectory}}, \code{\link{wrap_ti_task_data}} or \code{\link[dynmethods]{wrap_prediction_model}}
#' @param insert_phantom_edges attempt to plot bifurcating edges correctly automatically
#'
#' @importFrom grid arrow
#' @importFrom cowplot theme_cowplot
